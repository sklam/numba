...
def remove_dead_parfor(parfor, lives, args, typemap):
    ...
    remove_dead_parfor_recursive(parfor, lives, args, typemap)
    return
...
def remove_dead_parfor_recursive(parfor, lives, args, typemap):
    ...
    remove_dead(blocks, args, typemap)
