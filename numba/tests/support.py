...
# Require RVSDG_frontend to run the test
rvsdg_enabled = config.USE_RVSDG_FRONTEND
skip_unless_rvsdg_frontend_enabled = unittest.skipUnless(
    rvsdg_enabled, "Require RVSDG-frontend",
)
